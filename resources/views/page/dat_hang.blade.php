						...
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									<!--  one item	 -->
										<div class="media">
											<img width="25%" src="source/image/product/{{$cart['items'][image]}}" alt="" class="pull-left">
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">@if(Session::has('cart)){{number_format($totalPrice)}}đ</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
